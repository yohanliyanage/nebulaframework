...
public class BenchmarkSOR extends AbstractBenchmarkJob implements SplitAggregateGridJob<ExecutionResult, Double> {
	...
	public BenchmarkSOR(int taskCount) {
		super(taskCount);
	}
	...
	public Double aggregate(List<? extends Serializable> results) {
		...
		return CalculationSupport.getSOR(cycles, effectiveTime);
	}
