...
public class TaskExecutor {
	...
	/**
	 * The {@link TaskMessageListener} used by the TaskExecutor waits for this
	 * amount of milliseconds for a Task, before timing out to check if the
	 * {@code GridJob} has been stopped.
	 */
	public static final long TASK_WAIT_TIMEOUT = 5000L;
	...
	private AtomicInteger taskCount = new AtomicInteger(); // # of Tasks
															// Executed
	...
	protected class TaskMessageListener implements MessageListener {
		...
		public TaskMessageListener(ConnectionFactory connectionFactory) {
			...
			taskTemplate.setReceiveTimeout(TASK_WAIT_TIMEOUT);
